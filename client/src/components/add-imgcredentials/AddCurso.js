...
import { subirImagen, getCurrentImage } from "../../actions/imageActions";
...
class AddCurso extends Component {
  ...
  componentDidMount() {
    if (!!this.props.match.params.idImagen) {
      this.props.getCurrentImage(this.props.match.params.idImagen);
    }
  }
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (!!image) {
      this.setState({
        ...
        imageSVG: image.imageSVG,
        imagePreviewUrl: image.imageSVG
      });
    }
  }
...
export default connect(mapStateToProps, { subirImagen, getCurrentImage })(
  withRouter(AddCurso)
);
