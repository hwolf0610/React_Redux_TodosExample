...
import { createTema, getCurrentTema } from "../../actions/temasActions";
...
class CrearTema extends Component {
  ...
  componentDidMount() {
    if (!!this.props.match.params.idTema) {
      this.props.getCurrentTema(this.props.match.params.idTema);
    }
  }
...
export default connect(mapStateToProps, { createTema, getCurrentTema })(
